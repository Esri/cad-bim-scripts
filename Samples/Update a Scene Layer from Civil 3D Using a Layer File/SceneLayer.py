...
# Sign in to ArcGIS Online for ArcPy and ArcGIS Python API
...
# Set up to create a scene layer package from existing layer definition
...
# Create a scene layer package with new content
...
# Replace the existing scene layer with the updated version
